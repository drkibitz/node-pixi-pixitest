...
(function(e){if("function"==typeof bootstrap)bootstrap("pixitest",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makePixitest=e}else"undefined"!=typeof window?window.pixitest=e():global.pixitest=e()})(function(){var define,ses,bootstrap,module,exports;
...
exports.confirmNew = function (obj) {
    ...
    Point.confirm(obj.position, 0, 0);
    expect(obj).to.contain.property('scale');
    Point.confirm(obj.scale, 1, 1);
    expect(obj).to.contain.property('pivot');
    Point.confirm(obj.pivot, 0, 0);
...
},{"../geom/Point":6,"../textures/Texture":10,"./DisplayObjectContainer":2}],4:[function(require,module,exports){
'use strict';
...
},{"../display/DisplayObjectContainer":2}],6:[function(require,module,exports){
'use strict';
...
exports.confirmNewMat3 = function (matrix) {
...
exports.confirmNewMat4 = function (matrix) {
    expect(matrix).to.be.an.instanceof(PIXI.Matrix);
    expect(matrix).to.not.be.empty;
...
},{"./display/DisplayObject":1,"./display/DisplayObjectContainer":2,"./display/Sprite":3,"./events/EventTarget":4,"./extras/Strip":5,"./geom/Point":6,"./geom/Rectangle":7,"./geom/matrix":8,"./textures/Texture":10}],10:[function(require,module,exports){
'use strict';
...
},{"../events/EventTarget":4,"../geom/Point":6,"../geom/Rectangle":7}]},{},[9])(9)
});
;